...
SELECT PIDM,  SHRDGMR_SEQ_NO, SHRDGMR_DEGC_CODE, ROUND( AVG(GradePoints) , 2) AS GPA, COUNT(PIDM) AS NumCourses FROM (
...
-- and SHRTCKN_PIDM IN (90128737, 90152648)
...
AND AVG(GradePoints) > 4 -- filter by a threshold GPA
;